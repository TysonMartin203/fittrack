...
export function IconLogo({ className, style }) {
  return <svg className={className} style={style} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="32" height="32" rx="8" fill="#1C2E30"/><line x1="6" y1="16" x2="26" y2="16" stroke="#7EB09B" strokeWidth="2.5" strokeLinecap="round"/><rect x="4" y="11" width="3" height="10" rx="1" fill="#519E8A"/><rect x="2" y="13" width="2" height="6" rx="0.5" fill="#ECBEB4"/><rect x="25" y="11" width="3" height="10" rx="1" fill="#519E8A"/><rect x="28" y="13" width="2" height="6" rx="0.5" fill="#ECBEB4"/></svg>;
}
