...
function FireIcon(props) {
  return (
    <svg {...common} {...props}>
      <path d="M12 2.5c.5 3-2.5 4-2.5 7a2.5 2.5 0 0 0 5 0c0-1-.5-1.5-.5-1.5.8 1 1.5 2.3 1.5 3.7A4.5 4.5 0 0 1 11 16.2c0 0-5.5-2-5.5-7.3C5.5 5.5 8.5 4 12 2.5Z" fill="#D85A30"/>
      <path d="M9.5 15.5a2.5 2.5 0 0 0 5 0c0-1.1-1-2-1-2s-.2.6-.7.9c.2-.9-.3-1.7-.8-2.2-.2 1.4-1.3 1.8-1.7 2.6-.3.5-.8.8-.8.7Z" fill="#EF9F27"/>
    </svg>
  );
}
