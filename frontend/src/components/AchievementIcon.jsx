...
const ICONS = {
  ...
  ten_workouts: () => (
    <Icon>
      ...
      <path d="M16 25 C13 25 11 22 11 19 C11 17 13 15 14 14 C14 16 15.5 17 16 16.5 C16.5 14 17.5 12 19 11 C19 14 20 15 21 14 C22 16 22 18 21 20 C20 23 18 25 16 25Z" fill="#ECBEB4" opacity="0.6"/>
    </Icon>
  ),
  twenty_workouts: () => (
    <Icon>
