export const LIFTING_EXERCISES = [
  ...
  'Hip Abductor (Outer Thigh)','Hip Adductor (Inner Thigh)',
  // Arms - Biceps
  ...
  'Overhead Tricep Extension','Dip','Assisted Dip Machine','Kickback','Diamond Push-Up',
  // Core
...
export const CARDIO_ACTIVITIES = [
  'Running','Biking','Swimming','Walking','Rowing','Elliptical',
  'Stair Climber','Jump Rope','Hiking','HIIT','Other',
];

export const DISTANCE_UNITS = ['mi', 'km', 'm', 'laps', 'yd'];
